...
public class ShoulderBuddies extends CustomLayer implements MenuRenderLayer {
	public ShoulderBuddies(RenderLayerParent<PlayerRenderState, PlayerModel> renderLayerParent, EntityModelSet entityModelSet) {
