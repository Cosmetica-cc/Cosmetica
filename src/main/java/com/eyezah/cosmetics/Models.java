...
public class Models {
	...
	public static void renderModel(BakedModel model, PoseStack stack, MultiBufferSource multiBufferSource, int i) {
		stack.pushPose();
	...
	private static void renderModelLists(BakedModel bakedModel, int i, int j, PoseStack poseStack, VertexConsumer vertexConsumer) {
		...
		for(int var12 = 0; var12 < var11; ++var12) {
			...
			random.setSeed(seed);
			renderQuadList(poseStack, vertexConsumer, bakedModel.getQuads(null, direction, random), i, j);
		}

		random.setSeed(seed);
		renderQuadList(poseStack, vertexConsumer, bakedModel.getQuads(null, null, random), i, j);
	}
