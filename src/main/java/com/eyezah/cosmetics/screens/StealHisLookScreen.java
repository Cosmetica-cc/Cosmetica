...
public class StealHisLookScreen extends SulphateScreen {
	public StealHisLookScreen(Component pronounifiedTitle, PlayerData look, PlayerData ownLook, Screen parentScreen) {
	...
	protected void addWidgets() {
		...
		this.addButton(CommonComponents.GUI_YES, b -> this.minecraft.setScreen(new UpdatingCosmeticsScreen<>(this.parent, () -> {
